...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=f"{dir_path}/models_transfer/",
        save_top_k=2,
        monitor="val_loss",
    ...
    check_point_path = "/Users/user/Documents/Coding/cro_location_intelligence/src/models_transfer/pretrain.ckpt"
    ...
    for i, (path, _) in enumerate(trainer.checkpoint_callback.best_k_models.items()):
        ...
        PATH = f"./models_transfer/{i}th_best.pt"
