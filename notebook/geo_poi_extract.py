...
def main():
    ...
    # folder = "/Users/user/Documents/Coding/geo/notebook/data_7_eleven_google_map_poi_zoom_19/full_image"
    ...
    for image_name in tqdm(image_name_list):
        try:
            ...
            for result in results:
                ...
                poi_data = {"store_id":store_id,"bbox":bbox,"text":text,"confidence":confident}
